...
values
  ...
  ('00000000-0000-4000-8000-000000000001', 3, 'Consumption', 'Paid for something',
   'Someone pays, even a small amount, for what they discovered.',
   'A guest buys a drum or pays for a workshop.',
   'Receipt or payment record.',
   array['Purchase','Ticket or entry paid','Download or stream paid','Workshop fee paid','Other']),
